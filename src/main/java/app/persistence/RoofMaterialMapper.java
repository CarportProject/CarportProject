    ...
    public RoofMaterial findRoofMaterialById(int id, ConnectionPool connectionPool) throws DatabaseException {
        ...
        try (
            ...
            if (resultSet.next()) {
                ...
                System.err.println("[RoofMaterialMapper.findRoofMaterialById] ");
                throw new DatabaseException("Roof material not found");
            }

        } catch (SQLException e) {
            System.err.println("[RoofMaterialMapper.findRoofMaterialById] " + e.getMessage());
            throw new DatabaseException("An error occurred while fetching roof material");
        }
    }
}
